      ...
      <section id="pricing" className="py-20 px-4 bg-slate-50/70 border-t border-neutral-200/80">
        <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
          ...
          <p className="text-sm text-neutral-500 mb-10">
            Démarrez sans carte bancaire avec la formule gratuite.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full text-left">
            {/* Free */}
            <div className="bg-white border border-neutral-200 rounded-2xl p-7 flex flex-col justify-between shadow-xs">
              <div>
                ...
                <p className="text-xs text-neutral-600 mb-5">Parfait pour créer une première carte de visite et partager vos contacts.</p>
                ...
                <ul className="flex flex-col gap-2.5 text-xs text-neutral-700">
                  <li className="flex items-center gap-2">
                    ...
                    <span>Lien personnalisé (`lien.me/@vous`)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-neutral-800 shrink-0" />
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-neutral-800 shrink-0" />
                    <span>Téléchargement de contact vCard</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-neutral-800 shrink-0" />
              ...
              <Link
                href="/register"
                className="w-full mt-7 py-3 rounded-xl bg-neutral-100 hover:bg-neutral-200 text-neutral-800 text-xs font-bold text-center transition border border-neutral-200"
              >
            ...
            {/* Lifetime Pro */}
            <div className="bg-neutral-900 text-white rounded-2xl p-7 flex flex-col justify-between shadow-md relative">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs font-bold uppercase tracking-wider text-amber-400">Pack Pro À Vie</span>
                  <span className="px-2 py-0.5 rounded-full bg-amber-400/20 text-amber-300 text-[10px] font-bold">
                    Paiement unique
                  </span>
                </div>
                <div className="mt-2 mb-3">
                  <span className="text-3xl font-black text-white">186 $</span>
                  <span className="text-xs text-neutral-400 ml-1.5">à vie</span>
                </div>
                <p className="text-xs text-neutral-400 mb-5">Pour les indépendants qui veulent vendre des services et personnaliser chaque section.</p>
                ...
                <ul className="flex flex-col gap-2.5 text-xs text-neutral-200">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-amber-400 shrink-0" />
                    <span>Onglet Services & prise de rendez-vous</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-amber-400 shrink-0" />
                    <span>Boutique e-books & guides payants ou offerts</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-amber-400 shrink-0" />
                    <span>Badge certifié Pro sur votre profil</span>
                  </li>
                </ul>
              </div>
              ...
              <Link
                href="/register"
                className="w-full mt-7 py-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 text-xs font-bold text-center transition"
              >
                Passer en Pro à vie
              </Link>
            </div>
      ...
      <footer className="w-full py-8 border-t border-neutral-200 bg-white text-xs text-neutral-500">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="font-bold text-neutral-900">Lien.me</span>

  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto w-full text-left">
        ...
        {/* Plan PRO À VIE */}
        <div className="bg-neutral-950 text-white border-2 border-amber-500/70 rounded-2xl p-6 flex flex-col justify-between shadow-xl relative">
          ...
          <div>
            ...
            <span className="text-[11px] text-amber-300 font-semibold block mb-3">
              ≈ 300 000 FCFA en paiement unique définitif
            </span>
            <p className="text-xs text-neutral-300 mb-5">Payez une seule fois, profitez de toutes les fonctionnalités pour toujours (0 $ ensuite).</p>
          ...
          <button
            ...
            className="w-full mt-7 py-3 rounded-xl bg-gradient-to-r from-amber-400 via-amber-300 to-amber-500 hover:opacity-95 disabled:opacity-50 text-neutral-950 text-xs font-black text-center transition shadow-md flex items-center justify-center gap-2 hover:scale-[1.01]"
          >
